...
export default function SignInForm() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-[#f89b29] to-[#ff0f7b] overflow-hidden">
      <div className="w-full mt-20 max-w-md pt-6 p-5 bg-lightblue flex flex-col items-start justify-center gap-5 rounded-md border-2 border-black shadow-[4px_4px_0px_0px_black]">
        ...
        <form onSubmit={onSubmit} className="space-y-4 w-full">
          <div>
            <label className="block text-white font-bold mb-2" htmlFor="identifier">
              Email/Username
            </label>
            <Input
              id="identifier"
